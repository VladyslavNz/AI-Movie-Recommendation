...
recommendations = get_movie_recommendations(user_id_example, top_n=10, model=model, movies_df=movies_df, ratings_df=ratings_df, movie_id_to_idx=movie_id_to_idx, user_id_to_idx=user_id_to_idx)
